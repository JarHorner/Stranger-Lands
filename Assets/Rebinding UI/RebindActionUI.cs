...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = GetUsedControlScheme(action, bindingIndex)
        ...
        private InputActionRebindingExtensions.RebindingOperation GetUsedControlScheme(InputAction action, int bindingIndex)
        {
            Keyboard keyboardControlScheme = Keyboard.current;
            Gamepad gamepadControlScheme = Gamepad.current;

            InputActionRebindingExtensions.RebindingOperation rebindOperation;

            if (keyboardControlScheme.anyKey.wasPressedThisFrame)
            {
                return rebindOperation = action.PerformInteractiveRebinding(bindingIndex)
